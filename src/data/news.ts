...
"hecho": "El viernes 14 de agosto de 2026 el Tribunal Constitucional falló sobre la megarreforma tributaria. El TC mantuvo el pilar de invariabilidad tributaria a 20 años. Sin embargo, eliminó las indemnizaciones estatales a privados por RCA anuladas. La presidenta de la CPC, Susana Jiménez, expresó 'moderado optimismo' por la certeza jurídica que otorga la ratificación de los contratos de inversión.",
"impacto": "Se confirma que el pilar más sensible para atraer inversión extranjera sobrevivió al fallo del TC, lo que entrega tranquilidad al empresariado. No obstante, persiste el debate sobre cuánto se debilitó la iniciativa original del Gobierno.",
...
"hecho": "Este domingo 16 de agosto de 2026, el presidente del directorio de Codelco, Bernardo Fontaine, anunció en Mesa Central de Canal 13 que la estatal comenzará a publicar sus resultados y flujo de caja por división. Reconoció una 'crisis de desempeño' con costos cerca de 50% más altos que las grandes mineras del mundo. Confirmó además que evalúan vender participaciones en privados y cerrar un nuevo acuerdo con Pucobre por el proyecto Tovaku.",
"impacto": "Marca un giro en la transparencia y gestión de la principal cuprífera estatal, justo cuando Chile depende más que nunca del cobre para sostener su crecimiento. La evaluación de venta de activos se definirá en noviembre.",
...
"hecho": "El viernes 14 de agosto de 2026, la Subrei informó, con cifras del Banco Central y Aduanas, que las exportaciones de bienes acumularon US$70.603 millones entre enero y julio, un alza de 15% interanual. Solo en julio se exportaron US$10.248 millones, un 20% más que el año anterior y el mayor monto para ese mes desde que hay registros. La minería explicó el 61,4% de los envíos, con cobre por US$35.605 millones y litio por US$3.713 millones, casi triplicando su valor. Las exportaciones de alimentos también marcaron récord histórico con US$8.306 millones.",
